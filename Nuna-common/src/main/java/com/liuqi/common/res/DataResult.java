package com.liuqi.common.res;


import com.liuqi.common.e.DataResultException;
...
public class DataResult {
     ...
     */
    public void success(Object ...params) throws DataResultException {
        this.status = true;
     ...
     * @throws DataResultException 不处理异常，由外部处理
     */
    public void warning(Object ...params) throws DataResultException {
        this.status = true;
     ...
     * @throws DataResultException 不处理异常，由外部处理
     */
    public void error(Object ...params) throws DataResultException {
        this.status = false;
